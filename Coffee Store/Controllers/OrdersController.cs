...
namespace Coffee_Store.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderId,UserId,ItemName,Quantity,CreatedAt,Price,status")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,UserId,ItemName,Quantity,CreatedAt,Price,status")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
